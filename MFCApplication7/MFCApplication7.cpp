...
// MFCApplication7.cpp: 定义应用程序的类行为。
//
...
// 唯一的 CMFCApplication7App 对象

CMFCApplication7App theApp;

const GUID CDECL BASED_CODE _tlid =
		{0x38680c82,0x153b,0x46cd,{0xa9,0x7e,0x40,0xc9,0x3a,0xdb,0x7e,0xda}};
const WORD _wVerMajor = 1;
const WORD _wVerMinor = 0;


// CMFCApplication7App 初始化
